...
export const listProjects = [
  {
    ...
    description:
      "Undergraduate thesis investigating the privacy-preserving properties of synthetic financial datasets generated by various generative AI models.",
    button1Type: "fab fa-github",
    button1Link: "https://julia-wang.dev/Thesis4Pager.pdf",
    img: "https://github.com/JuliaLWang8/julialwang8.github.io/blob/master/src/media/proteinReactivity.png?raw=true",
    tech: ["Python", "TensorFlow", "VAEs", "GANs"],
    startDate: "Sep 2023",
    endDate: "May 2024",
  },
  {
